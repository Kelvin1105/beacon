...
public class addToEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gId = extras.getString("eId");
        gName = extras.getString("eName");
...
//                Toast.makeText(addBeaconToGroup.this,bPic+bName+macAddress,Toast.LENGTH_LONG).show();
            ...
            beaconCheckboxAdapter = new BeaconCheckboxAdapter(addToEvent.this, list);
    ...
    private void add() {
        ...
        class Add extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(addToEvent.this,"Adding...","Wait...",false,false);
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText( addToEvent.this,s,Toast.LENGTH_SHORT).show();
            ...
            protected String doInBackground(Void... v) {
                ...
                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(Config.URL_ADD_BEACON_TO_EVENT, params);
...
//                                friendId = friendId+","+adapter.getItem(i).toString();
            ...
            if(listItemID.size()==0){
                Toast.makeText( addToEvent.this,"select no data",Toast.LENGTH_SHORT).show();
...
//                                sb.append(listItemID.get(i)+",");
                ...
                Toast.makeText( addToEvent.this,macAddress,Toast.LENGTH_SHORT).show();
