...
public class Config{
    ...
    public static final String URL_GROUP_GET_BEACON = "http://140.117.71.114/beacon/groupGetBeacon.php";
    public static final String URL_GET_GROUP = "http://140.117.71.114/beacon/getGroup_test.php";
